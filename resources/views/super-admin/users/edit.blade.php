...
<div class="max-w-2xl mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('super-admin.users.show', $user) }}" class="text-blue-600 hover:text-blue-800">
                            {{ $user->name }}
                        </a>
                    </div>
                </li>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-800">Form Edit User</h2>
            <p class="text-gray-600 mt-1">Perbarui informasi user {{ $user->name }}</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="is_active" name="is_active" 
                        ...
                        <option value="0" {{ !old('is_active', $user->is_active) ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
                </div>
