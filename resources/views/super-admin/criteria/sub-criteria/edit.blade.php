...
@section('page-title', 'Edit Sub Kriteria: ' . $subCriteria->nama)
...
<div class="max-w-2xl mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-500">Edit {{ $subCriteria->nama }}</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-800">Form Edit Sub Kriteria</h2>
            <p class="text-gray-600 mt-1">Perbarui informasi sub kriteria</p>
        </div>

        <form action="{{ route('super-admin.criteria.sub-criteria.update', [$criteria, $subCriteria]) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" id="kode" name="kode" value="{{ old('kode', $subCriteria->kode) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama" name="nama" value="{{ old('nama', $subCriteria->nama) }}" 
            ...
            <div class="mb-4">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4" 
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $subCriteria->deskripsi) }}</textarea>
                @error('deskripsi')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    ...
                    <span class="ml-2 text-sm text-gray-700">Sub Kriteria Aktif</span>
                </label>
            </div>
