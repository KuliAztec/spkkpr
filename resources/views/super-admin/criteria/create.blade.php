...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-800">Form Tambah Kriteria</h2>
            <p class="text-gray-600 mt-1">Isi form di bawah untuk menambah kriteria baru</p>
        </div>
        ...
        <form action="{{ route('super-admin.criteria.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="kode" name="kode" value="{{ old('kode') }}" 
                       ...
                       placeholder="Contoh: C1, C2, dst..." required>
                @error('kode')
            ...
            <div class="mb-4">
                ...
                <input type="text" id="nama" name="nama" value="{{ old('nama') }}" 
                       ...
                       placeholder="Contoh: Character, Capacity, dll..." required>
                @error('nama')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
